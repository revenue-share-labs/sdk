...
import type { XLAValve_v010, XLAValve_v010Interface } from "../XLAValve_v010";
    ...
    inputs: [
      {
        indexed: false,
        internalType: "bool",
        name: "isImmutableRecipients",
        type: "bool",
      },
    ],
    name: "ImmutableRecipients",
    type: "event",
  },
  {
    anonymous: false,
...
export class XLAValve_v010__factory {
  static readonly abi = _abi;
  static createInterface(): XLAValve_v010Interface {
    return new utils.Interface(_abi) as XLAValve_v010Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XLAValve_v010 {
    return new Contract(address, _abi, signerOrProvider) as XLAValve_v010;
  }
}
