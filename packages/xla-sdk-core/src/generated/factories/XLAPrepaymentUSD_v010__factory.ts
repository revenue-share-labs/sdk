...
import type {
  ...
  XLAPrepaymentUSD_v010Interface,
} from "../XLAPrepaymentUSD_v010";
...
const _abi = [
    ...
    inputs: [
      {
        indexed: false,
        internalType: "address",
        name: "oldNativeCurrencyPriceFeed",
        type: "address",
      },
      {
        indexed: false,
        internalType: "address",
        name: "newNativeCurrencyPriceFeed",
        type: "address",
      },
    ],
    name: "NativeCurrencyPriceFeedSet",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "setNativeCurrencyPriceFeed",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class XLAPrepaymentUSD_v010__factory {
  static readonly abi = _abi;
  static createInterface(): XLAPrepaymentUSD_v010Interface {
    return new utils.Interface(_abi) as XLAPrepaymentUSD_v010Interface;
  }
  static connect(
    address: string,
