...
export interface XLAWaterfallUsd_v002Interface extends utils.Interface {
  functions: {
    ...
    "initialize((address,address[],address,bool,bool,uint256,uint256,address,address[],address[]),address[],uint256[],uint256[],address)": FunctionFragment;
    ...
    "setNativeTokenPriceFeed(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setNativeTokenPriceFeed",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "NativeTokenPriceFeedSet(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NativeTokenPriceFeedSet"): EventFragment;
...
export interface NativeTokenPriceFeedSetEventObject {
  oldNativeTokenPriceFeed: string;
  newNativeTokenPriceFeed: string;
}
export type NativeTokenPriceFeedSetEvent = TypedEvent<
  [string, string],
  NativeTokenPriceFeedSetEventObject
>;

export type NativeTokenPriceFeedSetEventFilter =
  TypedEventFilter<NativeTokenPriceFeedSetEvent>;
...
export interface XLAWaterfallUsd_v002 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XLAWaterfallUsd_v002Interface;
  ...
  functions: {
    ...
    initialize(
      ...
      _nativeTokenUsdPriceFeed: PromiseOrValue<string>,
  ...
  filters: {
    ...
    "NativeTokenPriceFeedSet(address,address)"(
      oldNativeTokenPriceFeed?: null,
      newNativeTokenPriceFeed?: null
    ): NativeTokenPriceFeedSetEventFilter;
    NativeTokenPriceFeedSet(
      oldNativeTokenPriceFeed?: null,
      newNativeTokenPriceFeed?: null
    ): NativeTokenPriceFeedSetEventFilter;
